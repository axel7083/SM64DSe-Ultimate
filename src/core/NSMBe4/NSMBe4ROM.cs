...
namespace SM64DSe.core.NSMBe4 {
    public static class NSMBe4ROM {
        ...
        public static NSMBe4File Arm9BinNsmBe4File;
        public static NSMBe4File Arm9OvNsmBe4File;
		public static NSMBe4Overlay[] arm9ovs;

        public static NSMBe4File Arm7BinNsmBe4File;
        public static NSMBe4File Arm7OvNsmBe4File;
		public static NSMBe4Overlay[] arm7ovs;

        public static NSMBe4File BannerNsmBe4File;
        public static NSMBe4File RsaSigNsmBe4File;
        public static NSMBe4File HeaderNsmBe4File;
        ...
        public static void load(Filesystem fs)
        {
			...
			Arm9BinNsmBe4File = FS.getFileByName("arm9.bin");			
			Arm9OvNsmBe4File = FS.getFileByName("arm9ovt.bin");	
			arm9ovs = loadOvTable(Arm9OvNsmBe4File);
			Arm7BinNsmBe4File = FS.getFileByName("arm7.bin");			
			Arm7OvNsmBe4File = FS.getFileByName("arm7ovt.bin");			
			arm7ovs = loadOvTable(Arm7OvNsmBe4File);
			RsaSigNsmBe4File = FS.getFileByName("rsasig.bin");			
			HeaderNsmBe4File = FS.getFileByName("header.bin");

            arm9RAMAddress = HeaderNsmBe4File.getUintAt(0x28);
			
            NSMBe4ByteArrayInputStream header = new NSMBe4ByteArrayInputStream(HeaderNsmBe4File.getContents());
        ...
        private static NSMBe4Overlay[] loadOvTable(NSMBe4File table)
        {
        	NSMBe4Overlay[] ovs = new NSMBe4Overlay[table.fileSize/32];
            ...
            while (tbl.lengthAvailable(32))
            {
				...
				ovs[ovId] = new NSMBe4Overlay(FS.getFileById(fileID), table, (uint)i*32);
        ...
        public static DSFileSystem.NSMBe4File getLevelFile(string filename)
        {
            return FS.getFileByName(filename + ".bin");
        }

        public static DSFileSystem.NSMBe4File getBGDatFile(string filename)
        {
        ...
        public static int[] FileSizes = {
                                            ...
                                            0x400, //Jyotyu_CHK
                                            NSMBe4ROM.SpriteCount*2, //Modifiers
                                        };
        ...
        {
            NSMBe4ByteArrayOutputStream res = new NSMBe4ByteArrayOutputStream();
